    ...
    series : [
        {
            ...
            center: ['55%', '60%'],
            data:[
                {value:1335, name:'大单流入'},
                {value:2310, name:'中单流入'},
                {value:2340, name:'小单流入'},
                {value:1350, name:'大单流出'},
                {value:1548, name:'中单流出'},
                {value:1548, name:'小单流出'},
            ],
            itemStyle: {
                emphasis: {
                    shadowBlur: 10,
...
InoutChart.setOption(InoutChartData);

//macd ...chart
var macdchart = echarts.init(document.getElementById('macd'));
macdchart.setOption(statisticoption);
var myChart4 = echarts.init(document.getElementById('kdj'));
myChart4.setOption(statisticoption);
var myChart5 = echarts.init(document.getElementById('rsi'));
myChart5.setOption(statisticoption);
var myChart6 = echarts.init(document.getElementById('boll'));
myChart6.setOption(statisticoption);
var myChart7 = echarts.init(document.getElementById('wr'));
myChart7.setOption(statisticoption);
var myChart8 = echarts.init(document.getElementById('asi'));
myChart8.setOption(statisticoption);
var myChart9 = echarts.init(document.getElementById('bias'));
myChart9.setOption(statisticoption);
var myChart10 = echarts.init(document.getElementById('vr'));
myChart10.setOption(statisticoption);
