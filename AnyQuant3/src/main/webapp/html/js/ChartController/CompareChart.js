...
var myeChart = echarts.init(document.getElementById('eKLine'));
myeChart.setOption(option);

myeChart2 = echarts.init(document.getElementById('echart2'));
myeChart2.setOption(option2);

myeChart3 = echarts.init(document.getElementById('echart3'));
myeChart3.setOption(option3);
//联动图表
echarts.connect([myeChart,myeChart3,myeChart2]);

var InoutChart = echarts.init(document.getElementById('InOutChart'));
InoutChart.setOption(option4);
